...
class ApplicationService(WSGIApplication):  
    """ 
    ...
    def __init__(self, services, tns):  
        ...
        return super(ApplicationService, self).__init__(Application(services, tns))  
    ...
    def __call__(self, request):  
        ...
        response = super(ApplicationService, self).__call__(request.META, start_response)  
